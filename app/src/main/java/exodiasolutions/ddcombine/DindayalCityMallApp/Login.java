    ...
    public void loginuser(View v){
        if(loginpressed==false){
            ...
            if(username_str.equalsIgnoreCase("")||password_str.equalsIgnoreCase("")){
                ...
                ReportLoader rl = new ReportLoader(Login.this);
                rl.execute();
            }}
    ...
    public class ReportLoader extends AsyncTask<Void,Void,String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try{
                ...
                URL url =new URL("https://corpzpro-incredible100rav.c9users.io/DDMALL/password_chk.php");
        ...
        protected void onPostExecute(String result ) {
            ...
            // Toast.makeText(Login.this, ""+username1, Toast.LENGTH_SHORT).show();
        }
    }
}
